...
p_mean_map <- ggplot() +
  ...
  scale_fill_viridis_c(
    option = "C",
    direction = 1,
    name = expression("NO"[2] * " annual mean (" * mu * "g/m"^3 * ")"),
  ...
  ggspatial::annotation_north_arrow(
    ...
    height = grid::unit(0.72, "cm"),
    width = grid::unit(0.72, "cm")
  ) +
  annotate(
    "text",
    x = bbox$xmin + (bbox$xmax - bbox$xmin) * 0.012,
    y = bbox$ymin + (bbox$ymax - bbox$ymin) * 0.018,
